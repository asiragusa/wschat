...
// ListUsersInteractor is an autogenerated mock type for the ListUsersInteractor type
type ListUsersInteractor struct {
	mock.Mock
}

// Call provides a mock function with given fields: _a0
func (_m *ListUsersInteractor) Call(_a0 request.ListUsers) response.Response {
	ret := _m.Called(_a0)

	var r0 response.Response
	if rf, ok := ret.Get(0).(func(request.ListUsers) response.Response); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
