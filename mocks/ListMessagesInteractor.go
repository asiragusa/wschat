...
// ListMessagesInteractor is an autogenerated mock type for the ListMessagesInteractor type
type ListMessagesInteractor struct {
	mock.Mock
}

// Call provides a mock function with given fields: _a0
func (_m *ListMessagesInteractor) Call(_a0 request.ListMessages) response.Response {
	ret := _m.Called(_a0)

	var r0 response.Response
	if rf, ok := ret.Get(0).(func(request.ListMessages) response.Response); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
